...
@section('contenu')
	<section id="login">
		...
		{!! Form::open(['url' => 'login', 'id' => 'loginForm']) !!}
			...
			{!! Form::label('date (AAAA-MM-JJ)', 'date (AAAA-MM-JJ)') !!}
			{!! Form::textarea('', 'Entrer votre Email :') !!}
			<!-- We create the field where we can write the email adress -->
			{!! Form::label('password', 'Mot de passe :') !!}
			{!! Form::textarea('email', null , array('autocomplete' => 'off', 'id' => 'emailSignup', 'placeholder' => 'Votre email', 'spellcheck' => 'false')) !!}
